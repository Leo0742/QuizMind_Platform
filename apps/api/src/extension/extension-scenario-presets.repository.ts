...
const select = { id:true, ownerUserId:true, sourceScenarioId:true, slug:true, name:true, description:true, buttonLabel:true, icon:true, schemaVersion:true, presetVersion:true, visibility:true, configJson:true, installCount:true, createdAt:true, updatedAt:true, disabledAt:true } satisfies Prisma.ExtensionScenarioPresetSelect;
@Injectable()
